                              ...
                              Row(
                                children: [
                                  ...
                                  Flexible(
                                    flex: 0,
                                    child: CustomButton(
                                      onPressed: () => cubit.applyCoupon(context),
                                      text: "Apply",
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("\$${cubit.withoutTax.toStringAsFixed(2)}",
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  (cubit.withoutTax > 1000)
                                      ...
                                      : Text("\$${cubit.shipping}", style: Theme.of(context).textTheme.bodySmall),
                                ],
                              ),
                              const SizedBox(height: 10),
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("\$${cubit.tax.toStringAsFixed(2)}", style: Theme.of(context).textTheme.bodySmall),
                                ],
                              ),
                              const Divider(),
                              const SizedBox(height: 8),
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("\$${cubit.total.toStringAsFixed(2)}", style: Theme.of(context).textTheme.bodyLarge
                                      ),
                                ],
                              ),
                            ],
